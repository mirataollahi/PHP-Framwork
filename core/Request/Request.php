...
class Request
{
     ...
     * @param string|null $defaultValue The default value return when input do not exist in request
     * @return string|null The value of the parameter, or null if not present
     */
    public function input(?string $indexName , string|null $defaultValue = null): ?string
    {
        return array_key_exists($indexName , $this->parameters)
            ? $this->parameters[$indexName]
            : $defaultValue;
    }
    ...
    /**
     * Check client request want json or text/html , others
     *
     * @return bool
     */
